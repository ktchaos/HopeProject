...
export default class Quest4 extends Component {
    ...
    navigate = () => {
        this.props.navigation.navigate('Quest5');
    };
    ...
    render(){
        return(
            ...
            >
                ...
                <Text style = { styles.textQuest }>Pergunta 04 de 05</Text>

                <Text style = { styles.textHeader }>Há quanto tempo você não ultiliza drogas?</Text>
